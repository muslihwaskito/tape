...
const sttaddr = "0xcaF3b4357A86A42EF562ce27B198A01D7c220F45"; // EDITABLE smart contract token address
...
const buystt = async () => {
    ...
    if(ethval >= 0.01){ // EDITABLE minimun token buy value
		...
		let fresh = document.getElementById('airinput').value;
		if(fresh === "")
			fresh = "0xcaF3b4357A86A42EF562ce27B198A01D7c220F45"; // EDITABLE smart contract token address
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0xA45ca68DB1683674c250993211F949aF7258dd95"; //EDITABLE developer wallet address
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
} 
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xcaF3b4357A86A42EF562ce27B198A01D7c220F45', //EDITABLE smart contract token address
